...
@JacksonXmlRootElement(localName = "paymentInitiationError")
public class PaymentInitiationError extends AbstractAuditMessage implements HasOffenceDetails, HasReceiptDetails {
    ...
    public PaymentInitiationError(String pageTransition) {
