...
@JacksonXmlRootElement(localName = "transactionSuccessful")
public class TransactionSuccessful extends AbstractAuditMessage implements HasOffenceDetails, HasReceiptDetails, HasPaymentDetails {
    ...
    public TransactionSuccessful(String pageTransition) {
